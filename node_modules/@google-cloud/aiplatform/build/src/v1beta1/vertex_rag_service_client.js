...
class VertexRagServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const asyncRetrieveContextsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.AsyncRetrieveContextsResponse');
        const asyncRetrieveContextsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.AsyncRetrieveContextsOperationMetadata');
