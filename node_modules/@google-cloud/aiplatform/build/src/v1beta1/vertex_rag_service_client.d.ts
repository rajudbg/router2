...
export declare class VertexRagServiceClient {
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1beta1.AskContextsResponse|AskContextsResponse}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta1/vertex_rag_service.ask_contexts.js</caption>
     * region_tag:aiplatform_v1beta1_generated_VertexRagService_AskContexts_async
     */
    askContexts(request?: protos.google.cloud.aiplatform.v1beta1.IAskContextsRequest, options?: CallOptions): Promise<[
        protos.google.cloud.aiplatform.v1beta1.IAskContextsResponse,
        protos.google.cloud.aiplatform.v1beta1.IAskContextsRequest | undefined,
        {} | undefined
    ]>;
    askContexts(request: protos.google.cloud.aiplatform.v1beta1.IAskContextsRequest, options: CallOptions, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IAskContextsResponse, protos.google.cloud.aiplatform.v1beta1.IAskContextsRequest | null | undefined, {} | null | undefined>): void;
    askContexts(request: protos.google.cloud.aiplatform.v1beta1.IAskContextsRequest, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IAskContextsResponse, protos.google.cloud.aiplatform.v1beta1.IAskContextsRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta1/vertex_rag_service.async_retrieve_contexts.js</caption>
     * region_tag:aiplatform_v1beta1_generated_VertexRagService_AsyncRetrieveContexts_async
     */
    asyncRetrieveContexts(request?: protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsResponse, protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsOperationMetadata>,
        protos.google.longrunning.IOperation | undefined,
        {} | undefined
    ]>;
    asyncRetrieveContexts(request: protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsResponse, protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    asyncRetrieveContexts(request: protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsRequest, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsResponse, protos.google.cloud.aiplatform.v1beta1.IAsyncRetrieveContextsOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * region_tag:aiplatform_v1beta1_generated_VertexRagService_AsyncRetrieveContexts_async
     */
    checkAsyncRetrieveContextsProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.AsyncRetrieveContextsResponse, protos.google.cloud.aiplatform.v1beta1.AsyncRetrieveContextsOperationMetadata>>;
    /**
