...
class IndexServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const importIndexResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Index');
        const importIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ImportIndexOperationMetadata');
        ...
        this.descriptors.longrunning = {
            ...
            importIndex: new this._gaxModule.LongrunningDescriptor(this.operationsClient, importIndexResponse.decode.bind(importIndexResponse), importIndexMetadata.decode.bind(importIndexMetadata)),
    ...
    initialize() {
        ...
        const indexServiceStubMethods = ['createIndex', 'getIndex', 'importIndex', 'listIndexes', 'updateIndex', 'deleteIndex', 'upsertDatapoints', 'removeDatapoints'];
    ...
    importIndex(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkImportIndexProgress(name) {
