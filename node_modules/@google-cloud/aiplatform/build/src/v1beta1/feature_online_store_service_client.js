...
class FeatureOnlineStoreServiceClient {
    ...
    initialize() {
        ...
        const featureOnlineStoreServiceStubMethods = ['fetchFeatureValues', 'streamingFetchFeatureValues', 'searchNearestEntities', 'featureViewDirectWrite', 'generateFetchAccessToken'];
