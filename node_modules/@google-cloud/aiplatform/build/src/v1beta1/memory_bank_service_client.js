...
exports.MemoryBankServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta1/memory_bank_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./memory_bank_service_client_config.json");
...
class MemoryBankServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            ragDataSchemaPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/ragCorpora/{rag_corpus}/ragDataSchemas/{rag_data_schema}'),
            ...
            ragMetadataPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/ragCorpora/{rag_corpus}/ragFiles/{rag_file}/ragMetadata/{rag_metadata}'),
        ...
        this.descriptors.page = {
            listMemories: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'memories')
        };
        ...
        const createMemoryResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Memory');
        const createMemoryMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateMemoryOperationMetadata');
        const updateMemoryResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Memory');
        const updateMemoryMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateMemoryOperationMetadata');
        const deleteMemoryResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteMemoryMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteMemoryOperationMetadata');
        const generateMemoriesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.GenerateMemoriesResponse');
        const generateMemoriesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.GenerateMemoriesOperationMetadata');
        this.descriptors.longrunning = {
            createMemory: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createMemoryResponse.decode.bind(createMemoryResponse), createMemoryMetadata.decode.bind(createMemoryMetadata)),
            updateMemory: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateMemoryResponse.decode.bind(updateMemoryResponse), updateMemoryMetadata.decode.bind(updateMemoryMetadata)),
            deleteMemory: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteMemoryResponse.decode.bind(deleteMemoryResponse), deleteMemoryMetadata.decode.bind(deleteMemoryMetadata)),
            generateMemories: new this._gaxModule.LongrunningDescriptor(this.operationsClient, generateMemoriesResponse.decode.bind(generateMemoriesResponse), generateMemoriesMetadata.decode.bind(generateMemoriesMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.MemoryBankService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.memoryBankServiceStub) {
            return this.memoryBankServiceStub;
        }
        // Put together the "service stub" for
        // google.cloud.aiplatform.v1beta1.MemoryBankService.
        this.memoryBankServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.aiplatform.v1beta1.MemoryBankService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.aiplatform.v1beta1.MemoryBankService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const memoryBankServiceStubMethods = ['createMemory', 'getMemory', 'updateMemory', 'listMemories', 'deleteMemory', 'generateMemories', 'retrieveMemories'];
        for (const methodName of memoryBankServiceStubMethods) {
            const callPromise = this.memoryBankServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getMemory(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('getMemory request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('getMemory response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.getMemory(request, options, wrappedCallback)
    ...
    retrieveMemories(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize().catch(err => { throw err; });
        this._log.info('retrieveMemories request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('retrieveMemories response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.retrieveMemories(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('retrieveMemories response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    createMemory(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, rawResponse, _) => {
                this._log.info('createMemory response %j', rawResponse);
                callback(error, response, rawResponse, _); // We verified callback above.
            }
            : undefined;
        this._log.info('createMemory request %j', request);
        return this.innerApiCalls.createMemory(request, options, wrappedCallback)
     ...
     */
    async checkCreateMemoryProgress(name) {
        this._log.info('createMemory long-running');
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createMemory, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    updateMemory(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, rawResponse, _) => {
                this._log.info('updateMemory response %j', rawResponse);
                callback(error, response, rawResponse, _); // We verified callback above.
            }
            : undefined;
        this._log.info('updateMemory request %j', request);
        return this.innerApiCalls.updateMemory(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('updateMemory response %j', rawResponse);
            return [response, rawResponse, _];
        });
     ...
     */
    async checkUpdateMemoryProgress(name) {
        this._log.info('updateMemory long-running');
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateMemory, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteMemory(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, rawResponse, _) => {
                this._log.info('deleteMemory response %j', rawResponse);
                callback(error, response, rawResponse, _); // We verified callback above.
            }
            : undefined;
        this._log.info('deleteMemory request %j', request);
        return this.innerApiCalls.deleteMemory(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('deleteMemory response %j', rawResponse);
            return [response, rawResponse, _];
        });
     ...
     */
    async checkDeleteMemoryProgress(name) {
        this._log.info('deleteMemory long-running');
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteMemory, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    generateMemories(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, rawResponse, _) => {
                this._log.info('generateMemories response %j', rawResponse);
                callback(error, response, rawResponse, _); // We verified callback above.
            }
            : undefined;
        this._log.info('generateMemories request %j', request);
        return this.innerApiCalls.generateMemories(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('generateMemories response %j', rawResponse);
            return [response, rawResponse, _];
        });
     ...
     */
    async checkGenerateMemoriesProgress(name) {
        this._log.info('generateMemories long-running');
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.generateMemories, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    listMemories(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, values, nextPageRequest, rawResponse) => {
                this._log.info('listMemories values %j', values);
                callback(error, values, nextPageRequest, rawResponse); // We verified callback above.
            }
            : undefined;
        this._log.info('listMemories request %j', request);
        return this.innerApiCalls
            .listMemories(request, options, wrappedCallback)
            ?.then(([response, input, output]) => {
            this._log.info('listMemories values %j', response);
     ...
     *   for more details and examples.
     */
    listMemoriesStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const defaultCallSettings = this._defaults['listMemories'];
        const callSettings = defaultCallSettings.merge(options);
        this.initialize().catch(err => { throw err; });
        this._log.info('listMemories stream %j', request);
        return this.descriptors.page.listMemories.createStream(this.innerApiCalls.listMemories, request, callSettings);
    }
    /**
     ...
     */
    listMemoriesAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize().catch(err => { throw err; });
        this._log.info('listMemories iterate %j', request);
        return this.descriptors.page.listMemories.asyncIterate(this.innerApiCalls['listMemories'], request, callSettings);
    }
    /**
     ...
     */
    close() {
        if (this.memoryBankServiceStub && !this._terminated) {
            return this.memoryBankServiceStub.then(stub => {
...
exports.MemoryBankServiceClient = MemoryBankServiceClient;
//# sourceMappingURL=memory_bank_service_client.js.map