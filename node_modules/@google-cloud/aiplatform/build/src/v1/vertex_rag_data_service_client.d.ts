...
export declare class VertexRagDataServiceClient {
     ...
     */
    getRagEngineConfig(request?: protos.google.cloud.aiplatform.v1.IGetRagEngineConfigRequest, options?: CallOptions): Promise<[
        protos.google.cloud.aiplatform.v1.IRagEngineConfig,
        protos.google.cloud.aiplatform.v1.IGetRagEngineConfigRequest | undefined,
        {} | undefined
    ]>;
    getRagEngineConfig(request: protos.google.cloud.aiplatform.v1.IGetRagEngineConfigRequest, options: CallOptions, callback: Callback<protos.google.cloud.aiplatform.v1.IRagEngineConfig, protos.google.cloud.aiplatform.v1.IGetRagEngineConfigRequest | null | undefined, {} | null | undefined>): void;
    getRagEngineConfig(request: protos.google.cloud.aiplatform.v1.IGetRagEngineConfigRequest, callback: Callback<protos.google.cloud.aiplatform.v1.IRagEngineConfig, protos.google.cloud.aiplatform.v1.IGetRagEngineConfigRequest | null | undefined, {} | null | undefined>): void;
    /**
     * Creates a RagCorpus.
     *
     * @param {Object} request
     ...
     */
    updateRagEngineConfig(request?: protos.google.cloud.aiplatform.v1.IUpdateRagEngineConfigRequest, options?: CallOptions): Promise<[
    ...
    updateRagEngineConfig(request: protos.google.cloud.aiplatform.v1.IUpdateRagEngineConfigRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1.IRagEngineConfig, protos.google.cloud.aiplatform.v1.IUpdateRagEngineConfigOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    updateRagEngineConfig(request: protos.google.cloud.aiplatform.v1.IUpdateRagEngineConfigRequest, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1.IRagEngineConfig, protos.google.cloud.aiplatform.v1.IUpdateRagEngineConfigOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * region_tag:aiplatform_v1_generated_VertexRagDataService_UpdateRagEngineConfig_async
     */
    checkUpdateRagEngineConfigProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.RagEngineConfig, protos.google.cloud.aiplatform.v1.UpdateRagEngineConfigOperationMetadata>>;
    /**
