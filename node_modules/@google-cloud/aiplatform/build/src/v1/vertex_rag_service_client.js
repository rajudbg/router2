...
class VertexRagServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const asyncRetrieveContextsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.AsyncRetrieveContextsResponse');
        const asyncRetrieveContextsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.AsyncRetrieveContextsOperationMetadata');
        this.descriptors.longrunning = {
            asyncRetrieveContexts: new this._gaxModule.LongrunningDescriptor(this.operationsClient, asyncRetrieveContextsResponse.decode.bind(asyncRetrieveContextsResponse), asyncRetrieveContextsMetadata.decode.bind(asyncRetrieveContextsMetadata))
        };
    ...
    initialize() {
        ...
        const vertexRagServiceStubMethods = ['retrieveContexts', 'augmentPrompt', 'corroborateContent', 'askContexts', 'asyncRetrieveContexts'];
    ...
    askContexts(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    asyncRetrieveContexts(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkAsyncRetrieveContextsProgress(name) {
