...
class SessionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createSessionResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.Session');
        const createSessionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateSessionOperationMetadata');
        const deleteSessionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteSessionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.SessionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.sessionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.aiplatform.v1.SessionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.aiplatform.v1.SessionService, this._opts, this._providedCustomServicePath);
