...
class ModelGardenServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const deployResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeployResponse');
        const deployMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeployOperationMetadata');
    ...
    initialize() {
        ...
        const modelGardenServiceStubMethods = ['getPublisherModel', 'deploy'];
