...
class FeatureOnlineStoreServiceClient {
    ...
    initialize() {
        ...
        const featureOnlineStoreServiceStubMethods = ['fetchFeatureValues', 'searchNearestEntities', 'featureViewDirectWrite', 'generateFetchAccessToken'];
    ...
    generateFetchAccessToken(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
