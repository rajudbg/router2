...
exports.DataFoundryServiceClient = void 0;
 ...
 */
const gapicConfig = require("./data_foundry_service_client_config.json");
 ...
 * @memberof v1
 */
class DataFoundryServiceClient {
    _terminated = false;
    _opts;
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.DataFoundryService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.dataFoundryServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.aiplatform.v1.DataFoundryService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.aiplatform.v1.DataFoundryService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of dataFoundryServiceStubMethods) {
            const callPromise = this.dataFoundryServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    generateSyntheticData(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
...
exports.DataFoundryServiceClient = DataFoundryServiceClient;
//# sourceMappingURL=data_foundry_service_client.js.map