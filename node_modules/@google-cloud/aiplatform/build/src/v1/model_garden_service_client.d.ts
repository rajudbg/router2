...
export declare class ModelGardenServiceClient {
     ...
     * @param {google.cloud.aiplatform.v1.DeployRequest.ModelConfig} [request.modelConfig]
     *   Optional. The model config to use for the deployment.
     *   If not specified, the default model config will be used.
     * @param {google.cloud.aiplatform.v1.DeployRequest.EndpointConfig} [request.endpointConfig]
     *   Optional. The endpoint config to use for the deployment.
     *   If not specified, the default endpoint config will be used.
     * @param {google.cloud.aiplatform.v1.DeployRequest.DeployConfig} [request.deployConfig]
     ...
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/model_garden_service.deploy.js</caption>
     * region_tag:aiplatform_v1_generated_ModelGardenService_Deploy_async
     */
    deploy(request?: protos.google.cloud.aiplatform.v1.IDeployRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.aiplatform.v1.IDeployResponse, protos.google.cloud.aiplatform.v1.IDeployOperationMetadata>,
        protos.google.longrunning.IOperation | undefined,
        {} | undefined
    ]>;
    deploy(request: protos.google.cloud.aiplatform.v1.IDeployRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1.IDeployResponse, protos.google.cloud.aiplatform.v1.IDeployOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    deploy(request: protos.google.cloud.aiplatform.v1.IDeployRequest, callback: Callback<LROperation<protos.google.cloud.aiplatform.v1.IDeployResponse, protos.google.cloud.aiplatform.v1.IDeployOperationMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * region_tag:aiplatform_v1_generated_ModelGardenService_Deploy_async
     */
    checkDeployProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1.DeployResponse, protos.google.cloud.aiplatform.v1.DeployOperationMetadata>>;
    /**
